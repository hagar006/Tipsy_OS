...
# Define home and rom
home=/data/jenkins/workspace/Tipsy_OS

# Differents necessary export
export PATH=/data/bin:$PATH
export USE_CCACHE=1
export CCACHE_DIR=/data/ccache/jenkins/TipsyOS
export TIPSY_BUILDTYPE=OFFICIAL
export KBUILD_BUILD_USER=Tipsy_Builder
...
if [ "$opt_off" -eq 2 ]; then
    echo -e "$ROUGE You are building an UNOFFICIAL Device for Tipsy $NORMAL"
    unset Tipsy_BUILDTYPE
    echo ""
fi
